...
#3. recupera somente o objeto results
data_results = data['results']

#4. monta o nome do arquivo
timestamp = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
filename = f"pokemon_list_{timestamp}.json"

#5. define o caminho dentro do volume do databricks
volume_path = f"/Volumes/raw/pokemon/pokemon_raw/pokemon_list/"

#6. define o caminho completo do arquivo
full_path = f"{volume_path}{filename}"

#7. grava o arquivo no Databricks 
